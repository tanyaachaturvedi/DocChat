...
from retrieval_generation import RAGPipeline
...
def main():
            ...
            if not question or question.strip() == "":
                ...
                with st.spinner("Searching documents and generating answer..."):
                    try:
                        ...
                        result = pipeline.query(question.strip(), return_context=True)
    ...
    • **Custom embeddings** for document understanding
    ...
    4. Expand sections to see search details
